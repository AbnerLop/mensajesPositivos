package edu.itesm.mensajespositivos;
...
public class MainActivity extends AppCompatActivity {
    ...
    private List<Integer> mensajeNum = new ArrayList<Integer>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "HARD_CODE_SEXY_TEXT", Toast.LENGTH_LONG).show();
    ...
    public void siguiente(View view){
        ...
        mensajeNum.add(random);
        textView.setText(mensajes[random]);
        Log.d(TAG, "RANDOM: " + random);
        Log.d(TAG,"NUMBER ADDED: " + mensajeNum.get(mensajeNum.size()-1));
    }

    public void atras(View view){
        if(mensajeNum.size() > 1){
            int lastMes = mensajeNum.get(mensajeNum.size()-2);
            Log.d(TAG, "LastMesIndex: " + lastMes);
            mensajeNum.remove(mensajeNum.get(mensajeNum.size()-1));
            textView.setText(mensajes[lastMes]);
        }
        else{
            Log.d(TAG, "SIZE: " + mensajeNum.size());
            textView.setText(mensajes[0]);
        }
    }
